...
import { Download, FileText, CheckCircle2, ArrowLeft, Eye, Star, Shield, Zap, ArrowRight } from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                <span className="text-slate-500 text-sm font-medium flex items-center gap-1">
                  <Zap className="w-3 h-3 fill-yellow-400 text-yellow-400" /> Platform Overview
                </span>
              </div>
              
              <h1 className="text-4xl md:text-5xl font-bold leading-tight text-slate-900 tracking-tight">
                VenioOne: <span className="text-primary relative whitespace-nowrap">
                  End-to-End eDiscovery
                </span>
              </h1>
              
              <p className="text-xl text-slate-600 leading-relaxed max-w-xl">
                Get a concise overview of VenioOne's capabilities, from processing and early case assessment 
                to review and production, all in a single unified platform.
              </p>
            ...
            <div className="relative lg:h-auto flex items-center justify-center">
              <div className="relative w-full max-w-md aspect-[8.5/11] group">
                ...
                <div className="absolute -z-10 top-10 -right-10 w-32 h-32 bg-purple-100 rounded-full blur-2xl opacity-60"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container max-w-6xl">
          <div className="text-center mb-16">
             ...
             <p className="text-slate-500 text-lg max-w-2xl mx-auto">
               Explore the powerful modules that make VenioOne the preferred choice for legal teams.
             </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: "Unified Processing", description: "Process terabytes of data with speed and precision." },
              { title: "Early Case Assessment", description: "Reduce data volumes quickly with advanced analytics." },
              { title: "AI-Powered Review", description: "Leverage CAL and predictive coding to find evidence faster." },
              { title: "Automated Redaction", description: "Protect sensitive PII/PHI automatically." },
              { title: "Production Export", description: "Flexible production options for any jurisdiction." },
              { title: "Legal Hold", description: "Manage custodians and notices seamlessly." }
            ].map((item, index) => (
