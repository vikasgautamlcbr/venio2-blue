...
const RoleEDiscoveryAttorneys = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
    if (typeof document !== "undefined") {
      document.title = "For eDiscovery Attorneys - Venio Systems";
      const desc = "Fast review, precise search, and quality production workflows built for eDiscovery attorneys.";
      ...
      const scriptId = "ld-json-role-ediscovery-attorneys";
      ...
      ld.text = JSON.stringify({
        ...
        "@type": "CollectionPage",
        "name": "For eDiscovery Attorneys",
        "url": window.location.origin + "/role-ediscovery-attorneys"
      });
      ...
      canonical.setAttribute("href", window.location.origin + "/role-ediscovery-attorneys");
    }
  }, []);
          ...
          <div className="relative z-10 container mx-auto px-6 max-w-5xl flex-1 flex items-center">
            <div className="text-center animate-fade-in w-full">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white">
                Built for eDiscovery Attorneys
              </h1>
              <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto leading-relaxed mb-10">
                Review faster with precise search, analytics, and production workflows optimized for accuracy.
              </p>
        ...
        <section className="py-16 px-6 bg-white border-t border-border/50">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-10">
              ...
              <p className="text-sm text-muted-foreground">Why attorneys choose Venio</p>
            </div>
                    ...
                    >
                      <AccordionItem value="end-to-end" className="border-b-0">
                        <AccordionTrigger className="group relative flex items-center justify-start gap-3 text-left text-2xl font-bold hover:no-underline rounded-2xl border border-transparent px-6 py-6 transition-all data-[state=open]:border-accent data-[state=open]:bg-accent/10 data-[state=open]:shadow-lg data-[state=open]:ring-1 data-[state=open]:ring-accent/30 hover:border-accent/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/30 [&>svg]:hidden">
                          ...
                          <span className="leading-tight">End-to-End Review</span>
                        </AccordionTrigger>
                        <AccordionContent className="pl-6">
                          <p className="text-muted-foreground mt-4 md:mt-6 mb-5 leading-relaxed">
                            Streamlined document review with analytics, batching, and precise search.
                          </p>
                          <div className="grid gap-3">
                            {["Advanced search","Analytics","Batching","Production-ready workflows"].map((t) => (
                      ...
                      <AccordionItem value="automation" className="border-b-0">
                        ...
                        <AccordionContent className="pl-6">
                          <p className="text-muted-foreground mt-4 md:mt-6 mb-5 leading-relaxed">
                            Automated reminders, QC steps, and defensible logs throughout review.
                          </p>
                          <div className="grid gap-3">
                            {["Reusable workflows","Automated follow‑ups","QC templates","Defensible logs"].map((t) => (
                              <div key={t} className="flex items-center gap-2 text-sm">
                                <CheckCircle2 className="h-4 w-4 text-primary" />
                                <span>{t}</span>
                              </div>
                      ...
                      <AccordionItem value="exports" className="border-b-0">
                        ...
                        <AccordionContent className="pl-6">
                          <p className="text-muted-foreground mt-4 md:mt-6 mb-5 leading-relaxed">
                            Export productions confidently with standardized outputs and validations.
                          </p>
                          <div className="grid gap-3">
        ...
        <section className="py-24 px-6 bg-muted/30">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Core capabilities for attorneys</p>
            </div>
...
export default RoleEDiscoveryAttorneys;
