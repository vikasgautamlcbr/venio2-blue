...
import { Shield, Brain, Cloud, Server, Workflow, DollarSign, Database, ArrowRight, Users, FileCheck, Bell, FileText, CheckCircle2, Landmark } from "lucide-react";
...
const ForGovernment = () => {
  useEffect(() => {
    ...
    if (typeof document !== "undefined") {
      document.title = "For Government & Public Sector - Venio Systems";
      const desc = "Secure, compliant eDiscovery and FOIA processing for government agencies. End-to-end automation, auditability, and performance in one platform.";
      ...
      const scriptId = "ld-json-for-government";
      ...
      ld.text = JSON.stringify({
        ...
        "@type": "CollectionPage",
        "name": "For Government & Public Sector",
        "url": window.location.origin + "/for-government"
      });
      ...
      canonical.setAttribute("href", window.location.origin + "/for-government");
    }
  }, []);
          ...
          <div className="relative z-10 container mx-auto px-6 max-w-5xl flex-1 flex items-center">
            <div className="text-center animate-fade-in w-full">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white">
                Transform Public Sector eDiscovery and FOIA
              </h1>
              <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto leading-relaxed mb-10">
                Secure, compliant, and auditable processing and review for agencies and public institutions, built for performance and transparency.
              </p>
              ...
              <Card className="group relative bg-card/80 backdrop-blur-sm border border-accent/20 hover:border-accent/40 transition-all duration-300 hover:shadow-[0_0_40px_rgba(50,220,120,0.3)] hover:scale-105 rounded-2xl overflow-hidden">
                <CardContent className="p-6">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-muted-foreground mb-4">Optimize costs and performance with hybrid deployments for agency flexibility.</p>
                    <Button asChild variant="outline">
        ...
        <section className="py-16 px-6 bg-white border-t border-border/50">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-10">
              ...
              <p className="text-sm text-muted-foreground">Why agencies choose Venio</p>
            </div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <AccordionItem value="exports" className="border-b-0">
                        ...
                        <AccordionContent className="pl-6">
                          <p className="text-muted-foreground mt-4 md:mt-6 mb-5 leading-relaxed">
                            Defensible productions with full QC, suitable for FOIA and regulatory requests.
                          </p>
                          <div className="grid gap-3">
                            {["FOIA formatting","Load file options","Redaction automation","Production validation"].map((t) => (
                              <div key={t} className="flex items-center gap-2 text-sm">
                                <CheckCircle2 className="h-4 w-4 text-primary" />
                                <span>{t}</span>
                              </div>
        ...
        <section className="py-24 px-6 bg-muted/30">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Core capabilities for public sector teams</p>
            </div>
