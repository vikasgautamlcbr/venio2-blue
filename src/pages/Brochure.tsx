...
import { Download, FileText, CheckCircle2, ArrowLeft, Eye, Star, Shield, Briefcase, ArrowRight } from "lucide-react";
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                <span className="text-slate-500 text-sm font-medium flex items-center gap-1">
                  <Briefcase className="w-3 h-3 fill-yellow-400 text-yellow-400" /> Company Overview
                </span>
              </div>
              
              <h1 className="text-4xl md:text-5xl font-bold leading-tight text-slate-900 tracking-tight">
                Venio Systems <span className="text-primary relative whitespace-nowrap">
                  Corporate Overview
                </span>
              </h1>
              
              <p className="text-xl text-slate-600 leading-relaxed max-w-xl">
                Download our corporate brochure to learn about our mission, our technology, 
                and why hundreds of organizations trust Venio with their most critical data.
              </p>
            ...
            <div className="relative lg:h-auto flex items-center justify-center">
              <div className="relative w-full max-w-md aspect-[8.5/11] group">
                ...
                <div className="absolute -z-10 top-10 -right-10 w-32 h-32 bg-pink-100 rounded-full blur-2xl opacity-60"></div>
              </div>
            </div>
          </div>
        </div>
