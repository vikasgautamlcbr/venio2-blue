...
import { Shield, Brain, Cloud, Server, Workflow, DollarSign, Database, ArrowRight, Zap, Users, FileCheck, Bell, FileText, CheckCircle2 } from "lucide-react";
...
const ForServiceProviders = () => {
  useEffect(() => {
    ...
    if (typeof document !== "undefined") {
      document.title = "For Service Providers - Venio Systems";
      let meta = document.querySelector('meta[name="description"]') as HTMLMetaElement | null;
      const desc = "Scalable eDiscovery for hosting partners. High-speed processing, automation, and multi-tenant workflows to deliver faster, lower-cost services.";
      if (meta) {
      ...
      const scriptId = "ld-json-for-service-providers";
      ...
      ld.text = JSON.stringify({
        ...
        "url": window.location.origin + "/for-service-providers"
      });
      ...
      canonical.setAttribute("href", window.location.origin + "/for-service-providers");
    }
  }, []);
          ...
          <div className="relative z-10 container mx-auto px-6 max-w-5xl flex-1 flex items-center">
            <div className="text-center animate-fade-in w-full">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white">
                Power Your eDiscovery Hosting Practice
              </h1>
              <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto leading-relaxed mb-10">
                Deliver faster throughput, lower costs, and consistent quality across clients with Venio’s high-speed, automation-first eDiscovery platform.
              </p>
              ...
              <Card className="group relative bg-card/80 backdrop-blur-sm border border-accent/20 hover:border-accent/40 transition-all duration-300 hover:shadow-[0_0_40px_rgba(50,220,120,0.3)] hover:scale-105 rounded-2xl overflow-hidden">
                <CardContent className="p-6">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-muted-foreground mb-4">Optimize costs and performance with hybrid deployments for client flexibility.</p>
                    <Button asChild variant="outline">
        ...
        <section className="py-16 px-6 bg-white border-t border-border/50">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-10">
              ...
              <p className="text-sm text-muted-foreground">Why hosting partners choose Venio</p>
            </div>
                    ...
                    >
                      <AccordionItem value="end-to-end" className="border-b-0">
                        ...
                        <AccordionContent className="pl-6">
                          <p className="text-muted-foreground mt-4 md:mt-6 mb-5 leading-relaxed">
                            From ingestion to production in a single platform—reduce handoffs and risk.
                          </p>
                          <div className="grid gap-3">
                            {["Multi-tenant projects","High-speed processing","AI-powered review","Defensible production"].map((t) => (
                      ...
                      <AccordionItem value="automation" className="border-b-0">
                        <AccordionTrigger className="group relative flex items-center justify-start gap-3 text-left text-2xl font-bold hover:no-underline rounded-2xl border border-transparent px-6 py-6 transition-all data-[state=open]:border-accent data-[state=open]:bg-accent/10 data-[state=open]:shadow-lg data-[state=open]:ring-1 data-[state=open]:ring-accent/30 hover:border-accent/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/30 [&>svg]:hidden">
                          ...
                          <span className="leading-tight">Automation & SLAs</span>
                        </AccordionTrigger>
                        <AccordionContent className="pl-6">
                          <p className="text-muted-foreground mt-4 md:mt-6 mb-5 leading-relaxed">
                            Templates and workflows to meet client SLAs consistently and at scale.
                          </p>
                          <div className="grid gap-3">
                            {["Reusable templates","Automated follow-ups","Batch operations","Robust audit trails"].map((t) => (
                              <div key={t} className="flex items-center gap-2 text-sm">
                                <CheckCircle2 className="h-4 w-4 text-primary" />
                                <span>{t}</span>
                              </div>
                      ...
                      <AccordionItem value="exports" className="border-b-0">
                        ...
                        <AccordionContent className="pl-6">
                          <p className="text-muted-foreground mt-4 md:mt-6 mb-5 leading-relaxed">
                            Standardized, defensible productions that reduce QC time and errors.
                          </p>
                          <div className="grid gap-3">
        ...
        <section className="py-24 px-6 bg-muted/30">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Core capabilities for service provider teams</p>
            </div>
            <div className="max-w-5xl mx-auto space-y-8">
              <div className="grid md:grid-cols-3 gap-6">
                {[
                  { icon: FileCheck, label: "Create & Launch", desc: "Set up projects in minutes" },
                  { icon: Users, label: "Multi-Tenant Control", desc: "Client and matter isolation" },
