...
const ForCorporations = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
    if (typeof document !== "undefined") {
      document.title = "For Corporations - Venio Systems";
      let meta = document.querySelector('meta[name="description"]') as HTMLMetaElement | null;
      if (meta) {
        meta.setAttribute("content", "Corporate eDiscovery with complete control, speed, and compliance. Explore deployment options, capabilities, and case studies tailored for corporate legal teams.");
      } else {
      ...
      const scriptId = "ld-json-for-corporations";
      ...
      ld.text = JSON.stringify({
        ...
        "url": window.location.origin + "/for-corporations"
      });
      ...
      canonical.setAttribute("href", window.location.origin + "/for-corporations");
    }
  }, []);
          ...
          <div className="relative z-10 container mx-auto px-6 max-w-5xl flex-1 flex items-center">
            <div className="text-center animate-fade-in w-full">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white">
                Transform Your Corporate eDiscovery Process
              </h1>
              <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto leading-relaxed mb-10">
                Cut costs by 60%, accelerate review by 70%, and deliver exceptional results with Venio's AI-powered eDiscovery platform designed for modern corporate legal teams.
              </p>
              <Button
                size="lg"
        ...
        <section className="py-16 px-6 bg-white border-t border-border/50">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-10">
              ...
              <p className="text-sm text-muted-foreground">Why teams choose Venio for corporate eDiscovery</p>
            </div>
        ...
        <section className="py-24 px-6 bg-muted/30">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Core capabilities for corporate eDiscovery teams</p>
            </div>
