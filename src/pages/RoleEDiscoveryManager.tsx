...
const RoleEDiscoveryManager = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
    if (typeof document !== "undefined") {
      document.title = "For eDiscovery Managers - Venio Systems";
      const desc = "Operate end‑to‑end projects with automation, tracking, and reporting. A control center for eDiscovery Managers.";
      ...
      const scriptId = "ld-json-role-ediscovery-manager";
      ...
      ld.text = JSON.stringify({
        ...
        "@type": "CollectionPage",
        "name": "For eDiscovery Managers",
        "url": window.location.origin + "/role-ediscovery-manager"
      });
      ...
      canonical.setAttribute("href", window.location.origin + "/role-ediscovery-manager");
    }
  }, []);
          ...
          <div className="relative z-10 container mx-auto px-6 max-w-5xl flex-1 flex items-center">
            <div className="text-center animate-fade-in w-full">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white">
                eDiscovery Manager Control Center
              </h1>
              <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto leading-relaxed mb-10">
                Operate projects end‑to‑end with automation, tracking, templates, and comprehensive reporting.
              </p>
        ...
        <section className="py-20 px-6 bg-white border-t border-border/50">
          <div className="container mx-auto max-w-7xl">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <Card className="group relative bg-card/80 backdrop-blur-sm border border-accent/20 hover:border-accent/40 transition-all duration-300 hover:shadow-[0_0_40px_rgba(61,196,126,0.3)] hover:scale-105 rounded-2xl overflow-hidden">
                <CardContent className="p-6">
                  <div className="absolute inset-0 bg-gradient-to-br from-primary/10 via-accent/5 to-transparent rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  <div className="absolute -inset-1 bg-gradient-to-br from-primary/20 via-accent/20 to-transparent rounded-2xl opacity-0 group-hover:opacity-50 blur-xl transition-opacity duration-300" />
                  <div className="relative">
                    ...
                    <p className="text-muted-foreground mb-4">Combine on‑premises control with cloud scalability for best‑fit governance.</p>
                    <Button asChild variant="outline">
        ...
        <section className="py-16 px-6 bg-white border-t border-border/50">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-10">
              ...
              <p className="text-sm text-muted-foreground">Why eDiscovery Managers choose Venio</p>
            </div>
                    ...
                    >
                      <AccordionItem value="end-to-end" className="border-b-0">
                        <AccordionTrigger className="group relative flex items-center justify-start gap-3 text-left text-2xl font-bold hover:no-underline rounded-2xl border border-transparent px-6 py-6 transition-all data-[state=open]:border-accent data-[state=open]:bg-accent/10 data-[state=open]:shadow-lg data-[state=open]:ring-1 data-[state=open]:ring-accent/30 hover:border-accent/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/30 [&>svg]:hidden">
                          ...
                          <span className="leading-tight">End-to-End Control</span>
                        </AccordionTrigger>
                        <AccordionContent className="pl-6">
                          <p className="text-muted-foreground mt-4 md:mt-6 mb-5 leading-relaxed">
                            Centralize operations from legal hold to production with consistent workflows.
                          </p>
                          <div className="grid gap-3">
                            {["Templates","Automation","Tracking","Production workflows"].map((t) => (
                      ...
                      <AccordionItem value="automation" className="border-b-0">
                        <AccordionTrigger className="group relative flex items-center justify-start gap-3 text-left text-2xl font-bold hover:no-underline rounded-2xl border border-transparent px-6 py-6 transition-all data-[state=open]:border-accent data-[state=open]:bg-accent/10 data-[state=open]:shadow-lg data-[state=open]:ring-1 data-[state=open]:ring-accent/30 hover:border-accent/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/30 [&>svg]:hidden">
                          ...
                          <span className="leading-tight">Automation & Reporting</span>
                        </AccordionTrigger>
                        <AccordionContent className="pl-6">
                          <p className="text-muted-foreground mt-4 md:mt-6 mb-5 leading-relaxed">
                            Automate repetitive tasks and track KPIs with real‑time dashboards.
                          </p>
                          <div className="grid gap-3">
                            {["Reusable templates","Automated follow‑ups","Operational dashboards","Defensible logs"].map((t) => (
                              <div key={t} className="flex items-center gap-2 text-sm">
                                <CheckCircle2 className="h-4 w-4 text-primary" />
                                <span>{t}</span>
                              </div>
                      ...
                      <AccordionItem value="exports" className="border-b-0">
                        ...
                        <AccordionContent className="pl-6">
                          <p className="text-muted-foreground mt-4 md:mt-6 mb-5 leading-relaxed">
                            Standardized productions that reduce QC time and align with SLAs.
                          </p>
                          <div className="grid gap-3">
        ...
        <section className="py-24 px-6 bg-muted/30">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Core capabilities for eDiscovery managers</p>
            </div>
...
export default RoleEDiscoveryManager;
