...
import { Shield, Brain, Cloud, Server, Workflow, DollarSign, Database, ArrowRight, Users, FileCheck, Bell, FileText, CheckCircle2, Search } from "lucide-react";
...
const ForInvestigationsCompliance = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
    if (typeof document !== "undefined") {
      document.title = "For Investigations & Compliance Teams - Venio Systems";
      const desc = "Rapid ingestion, AI-driven triage, and defensible reporting for internal investigations and compliance matters.";
      ...
      const scriptId = "ld-json-for-investigations-compliance";
      ...
      ld.text = JSON.stringify({
        ...
        "@type": "CollectionPage",
        "name": "For Investigations & Compliance Teams",
        "url": window.location.origin + "/for-investigations-compliance"
      });
      ...
      canonical.setAttribute("href", window.location.origin + "/for-investigations-compliance");
    }
  }, []);
          ...
          <div className="relative z-10 container mx-auto px-6 max-w-5xl flex-1 flex items-center">
            <div className="text-center animate-fade-in w-full">
              ...
              <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto leading-relaxed mb-10">
                Rapid ingestion, AI‑driven triage, and defensible reporting to surface the truth quickly and reliably.
              </p>
              ...
              <Card className="group relative bg-card/80 backdrop-blur-sm border border-accent/20 hover:border-accent/40 transition-all duration-300 hover:shadow-[0_0_40px_rgba(50,220,120,0.3)] hover:scale-105 rounded-2xl overflow-hidden">
                <CardContent className="p-6">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-muted-foreground mb-4">Tailor deployments to sensitive matters and investigation timelines.</p>
                    <Button asChild variant="outline">
        ...
        <section className="py-16 px-6 bg-white border-t border-border/50">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-10">
              ...
              <p className="text-sm text-muted-foreground">Why investigations and compliance teams choose Venio</p>
            </div>
                  ...
                  <div>
                    ...
                    >
                      <AccordionItem value="end-to-end" className="border-b-0">
                        ...
                        <AccordionContent className="pl-6">
                          ...
                          <div className="grid gap-3">
                            {["Rapid ingestion","AI triage","Targeted review","Clear reporting"].map((t) => (
                      ...
                      <AccordionItem value="automation" className="border-b-0">
                        ...
                        <AccordionContent className="pl-6">
                          <p className="text-muted-foreground mt-4 md:mt-6 mb-5 leading-relaxed">
                            Automated reminders, acknowledgements, and defensible logs for compliance.
                          </p>
                          <div className="grid gap-3">
                      ...
                      <AccordionItem value="exports" className="border-b-0">
                        ...
                        <AccordionContent className="pl-6">
                          <p className="text-muted-foreground mt-4 md:mt-6 mb-5 leading-relaxed">
                            Defensible productions for regulatory and internal reporting requirements.
                          </p>
                          <div className="grid gap-3">
        ...
        <section className="py-24 px-6 bg-muted/30">
          <div className="container mx-auto max-w-7xl">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Core capabilities for investigations and compliance teams</p>
            </div>
...
export default ForInvestigationsCompliance;
